import { Component, Input, OnInit, AfterViewInit, ViewEncapsulation, ElementRef } from '@angular/core';
import { FormGroup } from '@angular/forms';
import { Widget } from '../../models/widget';
@Component({
  selector: 'dm-integerrange',
  templateUrl: './integer-range.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['../../../assets/scss/homolo-datamodel.scss']
})
export class IntegerRangeComponent implements OnInit, AfterViewInit {
